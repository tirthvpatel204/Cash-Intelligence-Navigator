...
import { Wallet, Moon, Sun, ShieldCheck, User as UserIcon, LogIn, LogOut, Download } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navItems: { id: ActiveSection; label: string }[] = [
    ...
    { id: 'papers', label: 'Papers & Research' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2.5">
            ...
            {/* Login / Sign Up / Profile Section */}
            {currentUser ? (
              <div className="flex items-center space-x-1 pl-2 border-l border-stone-200 dark:border-stone-800">
                <button
                  onClick={onOpenAuth}
                  className="flex items-center space-x-2 py-1 px-1.5 rounded-lg hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors cursor-pointer text-left"
              ...
              <button
                onClick={onOpenAuth}
                className="flex items-center space-x-2 pl-2 border-l border-stone-200 dark:border-stone-800 cursor-pointer"
              >
